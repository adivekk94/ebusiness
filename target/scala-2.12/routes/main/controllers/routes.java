...
public class routes {
  ...
  public static final controllers.ReverseAccessController AccessController = new controllers.ReverseAccessController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseAccessController AccessController = new controllers.javascript.ReverseAccessController(RoutesPrefix.byNamePrefix());
